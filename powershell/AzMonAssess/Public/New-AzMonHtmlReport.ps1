...
function New-AzMonHtmlReport {
    ...
    if ($Snapshot['AiSummary']) {
        ...
        [void]$sb.AppendLine('    <h2>AI Executive Summary</h2>')
    ...
    [void]$sb.AppendLine('  Generated by <code>azmon-assess</code> — read-only assessment. Cost figures are directional; validate against your EA pricing.')
    [void]$sb.AppendLine('</footer>')
    [void]$sb.AppendLine('</body>')
