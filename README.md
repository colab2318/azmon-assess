...
| Alert quality scoring (noisy rules, missing critical rules, orphaned action groups) | Alert noise + under-alerting |
...
| **Cost Optimization (WAF, extended)** — App Insights daily cap, Sentinel commingled with ops data, Summary Rules candidates | Runaway telemetry cost, Sentinel surcharge waste |
